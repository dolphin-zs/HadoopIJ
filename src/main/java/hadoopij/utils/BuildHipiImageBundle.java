...
public class BuildHipiImageBundle {
    ...
    public static boolean isJPEGFile(String fn) {
    ...
    public static void createBundle(String fileName) throws IOException {
    ...
    private static void createBundleDirectory(String fileName, int K) throws IOException {
